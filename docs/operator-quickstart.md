# Operator Quickstart — Prepared Meals and Dishes Manufacturing Coordination

Shortest path from clone to a verified local dry-run for **ISIC 1075** (`cloud-itonami-isic-1075`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1075.git
cd cloud-itonami-isic-1075
```
...
- Blueprint governor key: `mealops-governor`
- Likely source path: `mealops.governor.cljc`
